...
int main(int argc, char** argv)
{
    ...
    Simulation.add_lagrangian_mono_particles(2,20,700,30e-6,0,15,300,300,1e5,1e3);
    ...
    Simulation.add_boundary_function(boundary::mass_flow_inlet,std::vector<double>{md,300,0,1,0});
